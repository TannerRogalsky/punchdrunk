class CanvasWebGL
  ...
  prepareDraw: ->
    ...
    @defaultProgram.sendMatrix("TransformMatrix", transformMatrix)
    @defaultProgram.sendMatrix("ProjectionMatrix", projectionMatrix)
    @defaultProgram.sendMatrix("TransformProjectionMatrix", transformProjectionMatrix)
